...
class Window:
    ...
    def __init__(self, title, layout=None, default_element_size=DEFAULT_ELEMENT_SIZE, default_button_element_size=(None, None),
                 ...
                 web_debug=False, web_ip='0.0.0.0', web_port=0, web_start_browser=True, web_update_interval=.0000001, web_multiple_instance=False, httppassword='', httpusername='' ):
        '''
    ...
    def remi_thread(self):
        ...
        try:
            remi.start(self.MyApp,
                       ...
                       update_interval=self.web_update_interval, userdata=(self,), username=self.httpusername, password=self.httppassword)
